...
public class Data_methods extends Ashish_tests {
	...
	@Test
	public static void Test() throws IOException, NullPointerException, ArrayIndexOutOfBoundsException, InterruptedException
	{
		Data();
		...
		try{
...

			{
				...
				for(int i=1;i<rowCount+1;i++)
				{
					...
					case "send_keys" : 
					{
						send_keys(driver,Data[i][2],Data[i][3],Data[i][4]);
						break;
					}
					case "click" :
					{
						click(driver,Data[i][2],Data[i][4]);
						break;
					}
					case "quit" :
					{
					...
					case "Select":
					{
						Select(driver,Data[i][3],Data[i][2],Data[i][4]);
						break;
					}
					case "Wait":
					{
					...
					case "gettext":
					{
						gettext(driver,Data[i][4],Data[i][2]);
						break;
					}
					case "submit":
					{
